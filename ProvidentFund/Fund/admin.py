...
class InvestmentDetailAdmin(admin.ModelAdmin):
    list_display=('account_name','id','account_type','status','investment_type','account_number','principal_amount','interest_amount','interest_start_date','interest_end_date','interest_percentage','tenure','remaining_days','rollover_principal','rollover_accumulated_amount','rollover_interest_percentage')
