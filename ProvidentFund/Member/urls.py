...
from . import views
from .views import EditMemberProfileView,TransactionView, WithdrawalView, verify_transaction,ManagerApprovalView
...
urlpatterns=[
    ...
    path('members/get-balance/', GetBalanceView.as_view(), name='get_balance'),
